...
const data = [
  ...
  ["Poimandres", "Creators of Leva, the most powerful parametric gui, and more great libraries.", "https://github.com/pmndrs/"],
  [
    "React Aria",
    "Live announcer, a great recipe to dynamically create aria-live messages.",
    "https://react-spectrum.adobe.com/react-aria/",
  ],
  ["Radix", "For the base color scheme and copy icon.", "https://www.radix-ui.com/"],
